...
4. Το σύστημα εμφανίζει σε μορφή λίστας όλες τις διοργανώσεις για το άθλημα που επέλεξε ο αντιπρόσωπος, με την κατηγορία της κάθε διοργάνωσης (π.χ. 5v5, 7x7 ,παίδες, παμπαιδικό κλπ. ).
5. Ο αντιπρόσωπος επιλέγει μία διοργάνωση από την λίστα που επιθυμεί ή αναζητά το όνομα μιας διοργάνωσης από την γραμμή αναζήτησης που υπάρχει στην σελίδα.
...
*6α. Δεν βρέθηκε διοργάνωση με το όνομα που δόθηκε από τον αντιπρόσωπο, σε περίπτωση αναζήτησης.*
1. Το σύστημα εμφανίζει μήνυμα σφάλματος.
