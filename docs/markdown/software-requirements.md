...
| ΕΚ7 | Κάθε ομάδα ανάλογα με την ηλικιακή κατηγορία της, μπορεί να συμμετέχει στην διοργάνωση με την αντίστοιχη ηλικιακή κατηγορία.
| ΕΚ8 | Κάθε διοργάνωση πρέπει να έχει έναν και μόνο νικητή.
| ΕΚ9 | Δεν μπορεί να κλείσει ή να διαγραφεί διοργάνωση όταν υπάρχουν αγώνες σε εξέλιξη.
| ΕΚ10 | Δεν μπορούν να συνυπάρχουν στην ίδια ομάδα άτομα, με μεγάλο εύρος στην ηλικία τους ( π.χ. 17 χρονών με 10 χρονών ).
| ΕΚ11 | Τα username και τα password πρέπει να αποτελούνται απο 5 τουλάχιστον χαρακτήρες.
| ΕΚ12 | Τα email πρέπει να είναι της μορφής : name@mailserver.domain .
| ΕΚ13 | Η ηλικία των διοργανωτών θα πρέπει να είναι άνω των 18 ετών.
| ΕΚ14 | Ο τίτλος είναι διαφορετικός για κάθε διοργανωτή.
| ΕΚ15 | Κάθε παίκτης μπορεί να συμμετέχει σε μία ομάδα για μία συγκεκριμένη διοργάνωση.
| ΕΚ16 | Αν καλυφθούν όλες οι θέσεις σε μια διοργάνωση δεν μπορεί να προστεθέι άλλη ομάδα.
| ΕΚ17 | Αν μια ομάδα συμμετέχει σε τρέχοντα γύρο διοργάνωσης δεν μπορεί να αποχωρήσει από αυτή.
| ΕΚ19 | Το όνομα της κάθε διοργάνωσης θα πρέπει να είναι μοναδικό.
