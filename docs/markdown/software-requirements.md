...
| ΕΚ5 | Όλα τα στοιχεία του χρήστη είναι υποχρεωτικά, εκτός από την περιοχή.
| ΕΚ6 | Το όνομα της κάθε ομάδας θα πρέπει να είναι μοναδικό.
| ΕΚ7 | Η χρονική περίοδος κάθε διοργάνωσης δεν μπορεί να υπερβαίνει το ένα έτος.
| ΕΚ8 | Ο μέγιστος αριθμός παικτών ανά ομάδα πρέπει να είναι 25.
| ΕΚ9 | Κάθε ομάδα ανάλογα με την ηλικιακή κατηγορία της, μπορεί να συμμετέχει στην διοργάνωση με την αντίστοιχη ηλικιακή κατηγορία.
| ΕΚ10 | Κάθε διοργάνωση πρέπει να έχει έναν και μόνο νικητή.
| ΕΚ11 | Δεν μπορεί να κλείσει ή να διαγραφεί διοργάνωση όταν υπάρχουν αγώνες σε εξέλιξη.
| ΕΚ12 | Δεν μπορούν να συνυπάρχουν στην ίδια ομάδα άτομα, με μεγάλο εύρος στην ηλικία τους ( π.χ. 17 χρονών με 10 χρονών ).
